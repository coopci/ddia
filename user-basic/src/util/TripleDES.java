...
public class TripleDES {
  ...
  public static void main(String[] args) {
    try {
      ...
      if (args[0].equals("-g")) { // Generate a key
        ...
        byte[] encrypted = encrypt(key, "2364354-4365824".getBytes());
        return;
  ...
  //public static String keyname = "TripleDES/ECB/PKCS5Padding";
  public static String keyname = "DESede";
  /** Generate a secret TripleDES encryption/decryption key */
  public static SecretKey generateKey() throws NoSuchAlgorithmException {
    // Get a key generator for Triple DES (a.k.a DESede)
    KeyGenerator keygen = KeyGenerator.getInstance(keyname);
