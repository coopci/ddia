...
/**
 * 获取属于自己的名字为参数name的容器的成员。
 * */
public class GetMembersByGlobalNameHandler extends HttpHandler {
	...
	public void service(Request request, Response response) throws Exception {
        ...
        String container_global_name = request.getParameter("container_name");
        ...
        Result res = this.engine.getMembersByGlobalName(uid, container_global_name, fields, start, limit);
